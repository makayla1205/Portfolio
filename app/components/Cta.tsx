        ...
        <div className="min-h-screen flex items-center bg-gradient-to-b from-slate-950 to-slate-900">
            <div className="flex flex-col lg:flex-row h-3/4 lg:items-center p-20 gap-10 w-full">
                <div className="w-full lg:min-w-150 mt-10">
                    <h1 className="text-7xl text-center md:text-left">Hi, I'm</h1>
                    <h1 className="text-7xl text-center md:text-left">Makayla Boyer</h1>
                    <p className="mt-5 text-xl text-center md:text-left">Great web experiences don't just happen—they're built with intention. 
