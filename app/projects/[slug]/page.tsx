...
export default async function Project({params}: {params: {slug: string};}) {
    ...
    console.log(project)
    return (
        <div className="min-h-screen p-20 pt-30 bg-gradient-to-b from-slate-900 to-slate-950 flex flex-col gap-10 items-center justify-center">
            <div className="w-full mt-3 text-center flex flex-col items-center">
                ...
                <p className="mt-3">Built With: {project.tools}</p>
                 <p className="mt-3 w-1/2">{project.description}</p>
            </div>
